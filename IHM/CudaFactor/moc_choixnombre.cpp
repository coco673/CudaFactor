...
struct qt_meta_stringdata_ChoixNombre_t {
    QByteArrayData data[4];
    char stringdata[41];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_ChoixNombre_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_ChoixNombre_t qt_meta_stringdata_ChoixNombre = {
    {
...
QT_MOC_LITERAL(3, 27, 12)
    ...
    "ChoixNombre\0changerNombre\0\0boutonClique\0"
};
...
void ChoixNombre::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->changerNombre(); break;
        case 1: _t->boutonClique(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject ChoixNombre::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_ChoixNombre.data,
      qt_meta_data_ChoixNombre,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_ChoixNombre.stringdata))
