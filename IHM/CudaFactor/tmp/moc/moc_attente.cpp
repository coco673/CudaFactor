...
static const char qt_meta_stringdata_Attente[] = {
    "Attente\0\0lancerExec()\0"
};
...
void Attente::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Attente *_t = static_cast<Attente *>(_o);
        switch (_id) {
        case 0: _t->lancerExec(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData Attente::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Attente::staticMetaObject = {
    { &Frame::staticMetaObject, qt_meta_stringdata_Attente,
      qt_meta_data_Attente, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Attente::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Attente))
