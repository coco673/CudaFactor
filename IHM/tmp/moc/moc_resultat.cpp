...
struct qt_meta_stringdata_Resultat_t {
    QByteArrayData data[3];
    char stringdata[23];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_Resultat_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_Resultat_t qt_meta_stringdata_Resultat = {
    {
QT_MOC_LITERAL(0, 0, 8),
QT_MOC_LITERAL(1, 9, 11),
QT_MOC_LITERAL(2, 21, 0)
    },
    "Resultat\0enregistrer\0\0"
};
...
const QMetaObject Resultat::staticMetaObject = {
    { &Frame::staticMetaObject, qt_meta_stringdata_Resultat.data,
      qt_meta_data_Resultat,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Resultat.stringdata))
