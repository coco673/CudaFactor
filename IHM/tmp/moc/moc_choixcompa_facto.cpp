...
struct qt_meta_stringdata_choixCompa_facto_t {
    QByteArrayData data[4];
    char stringdata[39];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_choixCompa_facto_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_choixCompa_facto_t qt_meta_stringdata_choixCompa_facto = {
    {
...
QT_MOC_LITERAL(3, 28, 9)
    ...
    "choixCompa_facto\0pressFact\0\0pressComp\0"
};
...
const QMetaObject choixCompa_facto::staticMetaObject = {
    { &Frame::staticMetaObject, qt_meta_stringdata_choixCompa_facto.data,
      qt_meta_data_choixCompa_facto,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_choixCompa_facto.stringdata))
